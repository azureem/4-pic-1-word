...
public class DialogNoMoney extends DialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.dialog_nomoney, container, false);


        view.findViewById(R.id.ok_hint).setOnClickListener(v->{
            dismiss();
        });
